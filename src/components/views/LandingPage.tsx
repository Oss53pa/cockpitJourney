...
function Pricing({ cms }: { cms?: PricingContent }) {
  ...
  const fallbackPlans = [
    {
      name: 'Solo & petite équipe',
      price: 25000,
      currency: 'FCFA',
      period: 'mois · forfait',
      tagline: 'jusqu’à 5 utilisateurs inclus',
      features: [
        '1 à 5 utilisateurs au forfait',
        'Projets illimités',
        'Daily Brief PROPH3T quotidien',
        'Goals & OKRs personnels & d’équipe',
    ...
    },
    {
      ...
      tagline: 'au-delà de 5 collaborateurs',
      features: [
        'Forfait base 25 000 FCFA / mois (5 utilisateurs)',
        '+ 15 000 FCFA / mois par utilisateur au-delà du 5ᵉ',
        'Tout du plan Solo & petite équipe',
        'Rapports IA hebdo / mensuels / trim.',
        'Goals hiérarchiques (équipe + perso)',
        'Mentions, watchers, commentaires',
        'Console Admin + invitations',
        'SSO Atlas Studio · SLA · onboarding dédié',
